...
class TimeSlotsSpecs extends AnyFlatSpecLike with Matchers:
  ...
  it should "combine two overlapping TimeSlots with the same resolution" in {
    ...
    val expected =
      TreeMap(
        odt"2024-02-02T11:15:00Z" -> Vector(1, 3),
        odt"2024-02-02T11:25:00Z" -> Vector(2),
  ...
  "TimeSlots.toMap()" should "return the underlying Map without any time gap" in {
    val actual =
      TimeSlots[Int](5.minutes)
    ...
    val expected =
      TreeMap(
        odt"2024-02-02T11:15:00Z" -> Vector(1),
        odt"2024-02-02T11:20:00Z" -> Vector.empty,
        odt"2024-02-02T11:25:00Z" -> Vector.empty,
        odt"2024-02-02T11:25:00Z" -> Vector(3),
        odt"2024-02-02T11:30:00Z" -> Vector(2),
        odt"2024-02-02T11:35:00Z" -> Vector.empty,
        odt"2024-02-02T11:40:00Z" -> Vector.empty,
